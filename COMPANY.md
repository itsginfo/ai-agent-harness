...
|-------|------|------|---------------|-----------|
| **CEO** | `agents/CEO.md` | Chief of Staff / COO | Strategy translation, cross-agent coordination, blocker removal | Google Drive, Monday.com |
...
| **CFO** | `agents/CFO.md` | Chief Financial Officer | Financial forecasting, runway, unit economics, budget allocation | Google Drive, Monday.com |
| **CMO** | `agents/CMO.md` | Chief Marketing Officer | Positioning, messaging, go-to-market strategy, content, CAC | Google Drive, Monday.com |
| **PM** | `agents/PM.md` | Project Manager | Per-project sprint execution, blocker escalation, delivery gates | Monday.com, Google Drive, GitHub |

**Independent Oversight Agents** (report directly to James — structural independence from agents they evaluate)

| Agent | File | Role | Primary Domain | Key Tools |
|-------|------|------|---------------|-----------|
| **Review** | `agents/REVIEW.md` | Review Agent | Output quality evaluation, agent definition audits, harness health | All project files (read), Google Drive, Monday.com |
...
| **Reliability** | `agents/RELIABILITY.md` | Reliability Agent | SLOs, deployment safety, incident response, DORA metrics | GitHub, Claude Code, Google Drive, Monday.com |
...
When referring to agents in handoffs, logs, and Monday.com tags, use the short names:
...
|------|---------|--------|-------|
| **Monday.com** | Project & task tracking | MCP connected | Primary work surface for PM; all agents tag items with their short name |
