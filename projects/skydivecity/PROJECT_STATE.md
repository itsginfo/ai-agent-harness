...
|------|----------|---------|------|
| **#15 GA4 purchase-tracking incident** | James sends BM reply, then awaiting BM remediation agreement | [`skydivecity-com#15`](https://github.com/itsginfo/skydivecity-com/issues/15) | Sev 3. Draft reply in `correspondence/`. Option A (single GTM pipeline) recommended. Test booking verifies after fix. |
