...
|------|----------|---------|-------|
| **May report — James review + send** | Send by 2026-06-05 (SOW §4.1) | [`skydivecity-com#10`](https://github.com/itsginfo/skydivecity-com/issues/10) | Content-complete + PDF rendered (`2026-05.pdf`). Delivery email drafted. **Never auto-send** — James sends To Rich / CC Matt, then log delivery date on `#10`. |
