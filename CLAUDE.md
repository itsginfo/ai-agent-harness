...
| **WoW AddOns** | `/Users/jamesmeirowsky/Projects/wow-addons/` | `/Users/jamesmeirowsky/Projects/wow-addons/CLAUDE.md` | GH Issues at `JamesMeirowsky/wow-addons` (gh auth via the **JamesMeirowsky** account — personal, NOT itsginfo; recurring reconciliation on `#1`). No Project board. Never used Monday. | CTO |
